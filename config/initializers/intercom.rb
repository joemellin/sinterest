IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "bgy3ovjf"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "LrUfqEsuF1r7UzUf9c9rYjf-56a4p3OS-Osh_W1N"
  ...
  #
  config.api_key = "02e8d2e7c9e60b4f42212880d8ffe74ea8fc6253"
